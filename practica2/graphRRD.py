...
print("coloca la fecha de tiempo inicial (dd.mm.yyyy 00:00:00)")
date_time = input()
pattern = '%d.%m.%Y %H:%M:%S'
...
ret2 = rrdtool.graphv( "paquetesIp.png",
                     ...
                     "GPRINT:segEntradaMax:%6.2lf %S segEntMAX",
                     "GPRINT:segEntradaDev:%6.2lf %S STDEV",
                     "LINE3:sEntrada#FF0000:Paquetes ip")
# print(ret2)
...
ret3 = rrdtool.graphv( "mensajesICMP.png",
                     ...
                     "GPRINT:segEntradaMax:%6.2lf %S segEntMAX",
                     "GPRINT:segEntradaDev:%6.2lf %S STDEV",
                     "LINE3:sEntrada#FF0000:Mensajes ICMP recibidos")
# print(ret3)
...
ret5 = rrdtool.graphv( "datagramas.png",
                     ...
                     "GPRINT:segEntradaMax:%6.2lf %S segEntMAX",
                     "GPRINT:segEntradaDev:%6.2lf %S STDEV",
                     "LINE3:sEntrada#FF0000:Datagramas enviados")
# print(ret5)